...
- **Hydration guard.** Before the company profile loads, the panel shows a loading line and its Save refuses. Save All leaves upgrade prices out until then. After that it carries this device's edits, so an edit is never silently dropped.
