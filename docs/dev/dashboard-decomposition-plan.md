...
| 2c-4+ | remaining allowlist clusters (dashboard-actions.js 87, dashboard-bootstrap.module.js 18, dashboard-ui.js 16, …) — same registry pattern, one module per PR | ⏳ next |
