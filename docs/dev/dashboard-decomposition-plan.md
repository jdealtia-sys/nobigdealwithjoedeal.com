...
| 2c-3+ | remaining allowlist clusters (dashboard-actions.js 87, dashboard-bootstrap.module.js 18, dashboard-ui.js 16, crm-portal-bridge.js 12, …) — same registry pattern, one module per PR | ⏳ next |
