...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.dpf-showall.active{color:var(--orange,#e8720c);border-color:var(--orange,#e8720c);background:color-mix(in srgb, var(--orange) 8%, transparent);}',
      ...
      '.dpf-required-banner{background:color-mix(in srgb, var(--orange) 8%, transparent);border:1px solid color-mix(in srgb, var(--orange) 25%, transparent);border-radius:10px;padding:12px 14px;margin-bottom:18px;font-size:12px;color:var(--orange,#e8720c);display:flex;align-items:center;gap:10px;}',
      ...
      '.dpf-input:focus,.dpf-textarea:focus,.dpf-select:focus{outline:none;border-color:var(--orange,#e8720c);box-shadow:0 0 0 2px color-mix(in srgb, var(--orange) 15%, transparent);}',
      ...
      '.dpf-photo-cell.selected{border-color:var(--orange,#e8720c);box-shadow:0 0 0 2px color-mix(in srgb, var(--orange) 25%, transparent);}',
      ...
      '.dpf-warranty-card.selected{border-color:var(--orange,#e8720c);background:color-mix(in srgb, var(--orange) 6%, transparent);}',
