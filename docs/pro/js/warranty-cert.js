...
async function generateWarrantyCertPDF() {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .brand span{color:var(--orange,#e8720c);}
    .brand-sub{font-size:9px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:var(--orange,#e8720c);border:1px solid #e8720c;padding:2px 10px;border-radius:2px;display:inline-block;margin-top:6px;}
    ...
    .guarantee-box .tier{font-family:'Barlow Condensed',sans-serif;font-size:14px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:var(--orange,#e8720c);margin-bottom:6px;}
    ...
    .feature-dot{width:8px;height:8px;border-radius:50%;background:var(--orange,#e8720c);flex-shrink:0;}
    ...
    .seal{width:60px;height:60px;border-radius:50%;border:3px solid #e8720c;display:flex;align-items:center;justify-content:center;font-family:'Barlow Condensed',sans-serif;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:var(--orange,#e8720c);text-align:center;line-height:1.3;padding:8px;}
