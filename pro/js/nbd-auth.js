    ...
    _initPromise = new Promise((resolve, reject) => {
      ...
      onAuthStateChanged(_auth, async (user) => {
        ...
        try {
          ...
          // Fail open on network error — don't bounce paying users
          console.warn('Subscription check failed — failing open:', e.message);
          _userPlan = 'professional';
          _subscription = { plan: 'professional', status: 'active', _failOpen: true };
        }
