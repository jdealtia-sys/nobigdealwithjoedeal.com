...
window.saveAsTemplate = function() {
  ...
  modal.innerHTML = `
    <div style="background:var(--s);border-radius:12px;max-width:500px;width:90%;padding:30px;">
      <h3 style="margin:0 0 20px 0;font-size:20px;color:var(--t);">Save as Template</h3>
      ...
      <div style="margin-bottom:15px;">
        ...
        <input type="text" id="templateName" value="${est.projectName}"
               ...
               style="width:100%;padding:10px;border:1px solid var(--br);border-radius:6px;">
      </div>
      ...
      <div style="margin-bottom:15px;">
        ...
        <textarea id="templateDescription" rows="3"
                  ...
                  style="width:100%;padding:10px;border:1px solid var(--br);border-radius:6px;resize:vertical;"></textarea>
      </div>
...
window.loadFromTemplate = function() {
  ...
  window.estimateTemplates.forEach(tpl => {
    ...
    templatesList += `
      <div onclick="applyTemplate('${tpl.id}');"
        ...
        <div style="display:flex;gap:20px;font-size:12px;color:var(--m);">
  ...
  modal.innerHTML = `
    <div style="background:var(--s);border-radius:12px;max-width:700px;width:90%;max-height:80vh;overflow:hidden;display:flex;flex-direction:column;">
      <div style="padding:25px;border-bottom:2px solid var(--br);">
        <h3 style="margin:0;font-size:20px;color:var(--t);">Load Template</h3>
      </div>
