...
const BOUNDARY_START = 'let _leadsSessionUid;';
const bindFn = lift(BOOT_SRC, 'function _bindLeadsCacheToSession(uid)');
...
ok('lead-cache boundary block lifted (session/cache uid + _resetLeadsCache + _bindLeadsCacheToSession)',
